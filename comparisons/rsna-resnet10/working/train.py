...
#data = pd.read_csv("/home/rfyahya/Desktop/Rawan/brain/clean/visual studios/dataframes/training_set_t2w.csv")
train_df = pd.read_csv("/dataframes/training_set_t2w.csv")
val_df = pd.read_csv("/dataframes/validation_set_t2w.csv")
...
#     plt.imshow(sample["image"].squeeze()[:,:,20])
#     plt.show()
