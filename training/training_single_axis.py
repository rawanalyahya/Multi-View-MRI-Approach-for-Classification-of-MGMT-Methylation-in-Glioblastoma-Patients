...
class train_single_view():
    ...
    def train_evaluate(self):
        ...
        auc = get_f1_score_precision_recall_single_input(best_model, self.dataloader_test,self.axis,nb_classes=2)
        f1_score, recall, precision = get_confusion_matrix_AUC_single_input(best_model, self.dataloader_test, self.axis)


        #write results in csv file
        file_name = ""
        if self.axis == 0:
            file_name = "experiments_x_axis_view_t2w.csv"
        elif self.axis == 1:
            file_name = "experiments_y_axis_view_t2w.csv"
        elif self.axis == 2:
            file_name = "experiments_z_axis_view_t2w.csv"
